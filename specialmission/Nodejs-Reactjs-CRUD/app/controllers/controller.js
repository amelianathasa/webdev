...
exports.createCustomer = (req, res) => {
  ...
  try {
    ...
    Customer.create(customer, { attributes: ["id", "firstname", "lastname", "age", "address"] }).then((result) => {
...
exports.customers = (req, res) => {
  ...
  try {
    Customer.findAll({ attributes: ["id", "firstname", "lastname", "age", "address"] }).then((customers) => {
...
exports.getCustomer = (req, res) => {
  Customer.findByPk(req.params.id, { attributes: ["id", "firstname", "lastname", "age", "address"] })
    .then((customer) => {
